...
ex2 <- kml::generateArtificialLongData(
   ...
   nbEachClusters=c(50,50,50), time = 0:4,
...
xLong = as.data.frame(matrix(as.vector(t(x)),ncol=1))
xLong$time = rep(colnames(x), times = nrow(x))
xLong$id = rep(1:nrow(x),each=5)
xLong = xLong[,c(3,2,1)];colnames(xLong)[3]="value"
```
